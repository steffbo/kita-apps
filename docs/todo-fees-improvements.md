...
- [x] **21. Tokens aus `localStorage`** (`8e85bb1`) – Refresh-Token als httpOnly-Cookie `fees_refresh`
...
- [x] **24. Playwright-E2E sauber aufsetzen** (`0302286`) – Suite im Repo statt Wegwerf-Skripte, eigene Test-DB, in CI
