...
/**
 * Legacy Playwright configuration for the paused Dienstplan/Zeiterfassung apps.
 * Not maintained and not run in CI; expects a manually prepared backend-management.
 * The Beiträge suite lives in playwright.config.ts (e2e/beitraege/).
 */
