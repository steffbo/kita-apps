...
type Household struct {
	...
	MembershipParentID    *uuid.UUID                 `json:"membershipParentId,omitempty" db:"membership_parent_id" binding:"optional"`
	MembershipStatus      MembershipAssignmentStatus `json:"membershipAssignmentStatus" db:"membership_assignment_status"`
	ChildrenCountForFees  *int                       `json:"childrenCountForFees,omitempty" db:"children_count_for_fees" binding:"optional"` // Override for sibling discount calculation
